...
- (void)viewDidLoad {
    [super viewDidLoad];
    _textView.placeholder = @"快来说说你的问题吧";
...
- (void)createQuestion:(NSString *)fileType
    ...
    [CourseHelper createQuestion:_textView.text stage_id:0 grade_id:0 subject_id:0 desc_image:imageMd desc_link:imageUrl structure_ids:nil to_user_ids:_ids is_anonymous:NO domain:self.domain target_id:self.target_id mark_at:self.mark_at desc_video:videoMd desc_audio:audioMd closely_answer_id:self.closely_answer_id success:^(id responseObject) {
        CreateQuestionModel *model = responseObject;
